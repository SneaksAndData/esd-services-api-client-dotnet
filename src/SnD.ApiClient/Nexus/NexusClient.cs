...
//
// public class NexusClient : SndApiClient, ICrystalClient
// {
...
//
//     public NexusClient(IOptions<CrystalClientOptions> crystalClientOptions, HttpClient httpClient,
//         IJwtTokenExchangeProvider boxerConnector, ILogger<NexusClient> logger) : base(httpClient, boxerConnector,
//         logger)
//     {
...
//     }
//     
//     public NexusClient(Uri baseUri) : base(null, null, null)
//     {
...
//     {
//         var request = new global::KiotaPosts.Client.Models.Models.AlgorithmRequest(); // TODO
//         
//         var response = await this.client.Algorithm.V1.Run[algorithm]
//             .PostAsWithAlgorithmNamePostResponseAsync(request, null, cancellationToken);
//         
